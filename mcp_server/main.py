...
from models import AcmeChallengeSet, Alt, FieldXgafv, RotateChallengesRequest
...
app = MCPProxy(
    ...
    title='ACME DNS API',
    version='v1',
    servers=[{'url': 'https://acmedns.googleapis.com/'}],
)
...
@app.get(
    ...
    tags=['acme_challenge_management'],
)
def acmedns_acme_challenge_sets_get(
    root_domain: str = Path(..., alias='rootDomain'),
...
def acmedns_acme_challenge_sets_rotate_challenges(
    ...
    upload_protocol: Optional[str] = None,
    upload_type: Optional[str] = Query(None, alias='uploadType'),
    body: RotateChallengesRequest = None,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
